<div class="bg-white">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        <div class="flex justify-center md:order-2">
            <a href="https://www.facebook.com/ceyouthchurch" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://www.instagram.com/ce_youthchurch/" class="ml-6 text-gray-400 hover:text-gray-500">
            ...
            <a href="https://twitter.com/ce_youthchurch" class="ml-6 text-gray-400 hover:text-gray-500">
            ...
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                    <div class="rounded-md shadow-sm">
                        ...
                        <button v-on:click.prevent="first_timer()" type="button"
                            ...
                            <i class="las la-handshake text-xl mr-1"></i> YES!
                        </button>
